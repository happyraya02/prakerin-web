...
<head>
    ...
    <link href="{{ asset('assets/frontend/https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css')}}" rel="stylesheet"
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-md-9 align-self-center fh5co_mediya_right">
                ...
                <!--<div class="d-inline-block text-center"><img src="{{ asset('assets/frontend/images/country.png')}}" alt="img" class="fh5co_country_width"/></div>-->
...
<div class="container-fluid bg-faded fh5co_padd_mediya padding_786">
    <div class="container padding_786">
        <nav class="navbar navbar-toggleable-md navbar-light ">
            ...
            <a class="navbar-brand" href="#"><img src="{{ asset('assets/frontend/images/logo.png')}}" alt="img" class="mobile_logo_width"/></a>
        ...
        <div class="owl-carousel owl-theme" id="slider2">
            <div class="item px-2">
                <div class="fh5co_hover_news_img">
                    <div class="fh5co_news_img"><img src="{{ asset('assets/frontend/images/j.jfif')}}" alt=""/></div>
                    <div>
                        <a href="single" class="d-block fh5co_small_post_heading"><span class="">The top 10 best computer speakers in the market</span></a>
            ...
            <div class="item px-2">
                <div class="fh5co_hover_news_img">
                    <div class="fh5co_news_img"><img src="{{ asset('assets/frontend/images/k.jfif')}}" alt=""/></div>
                    <div>
                        <a href="single" class="d-block fh5co_small_post_heading"><span class="">The top 10 best computer speakers in the market</span></a>
                        <div class="c_g"><i class="fa fa-clock-o"></i> Oct 16,2017</div>
                    </div>
            ...
            <div class="item px-2">
                <div class="fh5co_hover_news_img">
                    <div class="fh5co_news_img"><img src="{{ asset('assets/frontend/images/l.jfif')}}" alt=""/></div>
                    <div>
                        <a href="single" class="d-block fh5co_small_post_heading"><span class="">The top 10 best computer speakers in the market</span></a>
                        <div class="c_g"><i class="fa fa-clock-o"></i> Oct 16,2017</div>
                    </div>
            ...
            <div class="item px-2">
                <div class="fh5co_hover_news_img">
                    <div class="fh5co_news_img"><img src="{{ asset('assets/frontend/images/m.jfif')}}" alt=""/></div>
                    <div>
                        <a href="single" class="d-block fh5co_small_post_heading"><span class="">The top 10 best computer speakers in the market</span></a>
                        <div class="c_g"><i class="fa fa-clock-o"></i> Oct 16,2017</div>
                    </div>
                    ...
                    <div class="fh5co_hover_news_img">
                        <div class="fh5co_hover_news_img_video_tag_position_relative">
                            ...
                            <div class="fh5co_hover_news_img_video_tag_position_absolute fh5co_hide">
                                <img src="{{ asset('assets/frontend/images/n.jfif')}}" alt=""/>
                            </div>
                    ...
                    <div class="fh5co_hover_news_img">
                        <div class="fh5co_hover_news_img_video_tag_position_relative">
                            ...
                            <div class="fh5co_hover_news_img_video_tag_position_absolute fh5co_hide_2">
                                <img src="{{ asset('assets/frontend/images/o.jfif')}}" alt=""/></div>
                    ...
                    <div class="fh5co_hover_news_img">
                        <div class="fh5co_hover_news_img_video_tag_position_relative">
                            ...
                            <div class="fh5co_hover_news_img_video_tag_position_absolute fh5co_hide_3">
                                <img src="{{ asset('assets/frontend/images/p.jfif')}}" alt=""/></div>
                    ...
                    <div class="fh5co_hover_news_img">
                        <div class="fh5co_hover_news_img_video_tag_position_relative">
                            ...
                            <div class="fh5co_hover_news_img_video_tag_position_absolute fh5co_hide_4">
                                <img src="{{ asset('assets/frontend/images/q.jfif')}}" alt=""/>
                            </div>
        ...
        <div class="row mx-0">
            <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                ...
                <div class="row pb-4">
                    <div class="col-md-5">
                        <div class="fh5co_hover_news_img">
                            <div class="fh5co_news_img"><img src="{{ asset('assets/frontend/images/u.jfif')}}" alt=""/></div>
                            <div></div>
                        </div>
                    </div>
                    <div class="col-md-7 animate-box">
                        <a href="single" class="fh5co_magna py-2"> Magna aliqua ut enim ad minim veniam quis
                        nostrud quis xercitation ullamco. </a> <a href="single" class="fh5co_mini_time py-3"> Thomson Smith -
                        April 18,2016 </a>
                ...
                <div class="row pb-4">
                    <div class="col-md-5">
                        <div class="fh5co_hover_news_img">
                            <div class="fh5co_news_img"><img src="{{ asset('assets/frontend/images/v.jfif')}}" alt=""/></div>
                            <div></div>
                        </div>
                    </div>
                    <div class="col-md-7">
                ...
                <div class="row pb-4">
                    <div class="col-md-5">
                        <div class="fh5co_hover_news_img">
                            <div class="fh5co_news_img">
                                <img src="{{ asset('assets/frontend/images/w.jfif')}}" alt=""/>
                            </div>
                            <div></div>
                        </div>
                    </div>
                ...
                <div class="row pb-4">
                    <div class="col-md-5">
                        <div class="fh5co_hover_news_img">
                            <div class="fh5co_news_img"><img src="{{ asset('assets/frontend/images/x.jfif')}}" alt=""/></div>
                            <div></div>
                        </div>
                    </div>
                    <div class="col-md-7">
...
<div class="container-fluid fh5co_footer_bg pb-3">
    <div class="container animate-box">
        <div class="row">
            <div class="col-12 spdp_right py-5"><img src="{{ asset('assets/frontend/images/logo.png')}}" alt="img" class="footer_logo"/></div>
            <div class="clearfix"></div>
            ...
            <div class="col-12 col-md-5 col-lg-3 position_footer_relative">
                ...
                <div class="footer_makes_sub_font"> Dec 31, 2016</div>
                <a href="#" class="footer_post pb-4"> Success is not a good teacher failure makes you humble </a>
                <div class="footer_position_absolute"><img src="{{ asset('assets/frontend/images/z.jfif')}}" alt="img" class="width_footer_sub_img"/></div>
            </div>
            <div class="col-12 col-md-12 col-lg-4 ">
                <div class="footer_main_title py-3"> Last Modified Posts</div>
                <a href="#" class="footer_img_post_6"><img src="{{ asset('assets/frontend/images/1.jfif')}}" alt="img"/></a>
                <a href="#" class="footer_img_post_6"><img src="{{ asset('assets/frontend/images/2.jfif')}}" alt="img"/></a>
                <a href="#" class="footer_img_post_6"><img src="{{ asset('assets/frontend/images/3.jfif')}}" alt="img"/></a>
                <a href="#" class="footer_img_post_6"><img src="{{ asset('assets/frontend/images/4.jfif')}}" alt="img"/></a>
                <a href="#" class="footer_img_post_6"><img src="{{ asset('assets/frontend/images/5.jfif')}}" alt="img"/></a>
                <a href="#" class="footer_img_post_6"><img src="{{ asset('assets/frontend/images/6.jfif')}}" alt="img"/></a>
                <a href="#" class="footer_img_post_6"><img src="{{ asset('assets/frontend/images/7.jfif')}}" alt="img"/></a>
                <a href="#" class="footer_img_post_6"><img src="{{ asset('assets/frontend/images/8.jfif')}}" alt="img"/></a>
                <a href="#" class="footer_img_post_6"><img src="{{ asset('assets/frontend/images/9.jfif')}}" alt="img"/></a>
            </div>
        </div>
